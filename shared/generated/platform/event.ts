...
export const EventServiceService = {
  ingestEvent: {
    path: '/platform.EventService/IngestEvent' as const,
  ...
  getHistory: {
    path: '/platform.EventService/GetHistory' as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  streamEvents: {
    path: '/platform.EventService/StreamEvents' as const,
    requestStream: false as const,
  ...
  getEventCount: {
    path: '/platform.EventService/GetEventCount' as const,
    requestStream: false as const,
    responseStream: false as const,
