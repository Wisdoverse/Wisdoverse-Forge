...
const SECTIONS: SectionItem[] = [
  ...
  { id: 'keys', label: 'Outside Tool Access', group: 'Work Setup' },
  { id: 'git-credentials', label: 'Code Access', group: 'Work Setup' },
  { id: 'ssh-keys', label: 'git@ Code Access', group: 'Work Setup' },
