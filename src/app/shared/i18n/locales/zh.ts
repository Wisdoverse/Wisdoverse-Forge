...
export const zh: TranslationKeys = {
  ...
  gettingStarted: {
    ...
    steps: {
      ...
      provider: {
        title: '会话如何回答',
        empty: '接入模型服务或本机会话，让会话可以开始工作。',
        needsTest: '先检查模型服务，再分配工作。',
        cliReady: '{{name}} 可以从{{location}}执行工作。',
        why: '会话需要一个已检查的模型服务，或一个已接入的本机会话，才能回答或执行工作。',
        success: '模型服务已检查通过，或本机会话已经接入。',
        create: '添加模型服务',
        connectCli: '接入本机会话',
        test: '检查模型服务',
  ...
  settings: {
    ...
    runtime: {
      title: '会话工作设置',
      description: '选择会话默认在哪里工作，并查看下一步要补什么。',
      saving: '保存中...',
      loading: '加载工作设置...',
      ...
      defaultContainerCliDescription: '会话需要处理文件或命令时使用的工具',
      availableRuntimesLabel: '会话可以工作的地方',
      availableRuntimesDescription: '当前安装可使用的工作位置',
      availableContainerClisLabel: '可用工作工具',
      availableContainerClisDescription: '会话可用于文件和命令工作的工具',
      runtimeLabels: {
        cli: '这台电脑',
        api: '只处理文字的模型服务',
        container: '托管工作区',
