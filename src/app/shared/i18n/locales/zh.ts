...
export const zh: TranslationKeys = {
  ...
  gettingStarted: {
    ...
    steps: {
      ...
      provider: {
        title: 'Agent 如何回答',
        empty: '接入模型服务或本地 Agent，让 Agent 可以开始工作。',
        needsTest: '先检查模型服务，再分配工作。',
        cliReady: '{{name}} 可以从{{location}}执行工作。',
        why: 'Agent 需要一个已检查的模型服务，或一个已接入的本地 Agent，才能回答或执行工作。',
        success: '模型服务已检查通过，或本地 Agent 已经接入。',
        create: '添加模型服务',
        connectCli: '接入本地 Agent',
        test: '检查模型服务',
      ...
      agent: {
        title: 'Agent',
        empty: '创建一个文字 Agent、托管工作区 Agent，或本地 Agent。',
      ...
      routing: {
        title: '工作通道',
        emptyWithProject: '为当前项目创建工作通道。',
        emptyWithoutProject: '先选择项目，再创建工作通道。',
        why: '工作通道是新任务等待、Agent 领取任务的地方。',
        success: '当前项目下已经有一个工作通道。',
        create: '创建工作通道',
        review: '查看工作通道',
      },
      task: {
  ...
  settings: {
    ...
    runtime: {
      title: 'Agent 工作设置',
      description: '选择 Agent 默认在哪里工作，并查看下一步要补什么。',
      saving: '保存中...',
      loading: '加载工作设置...',
  ...
  skills: {
    detail: {
      ...
      triggerHeading: '哪些任务词会建议使用它',
      triggerHelper: '当任务里出现这些词时，agent 可以考虑使用这个技能。',
