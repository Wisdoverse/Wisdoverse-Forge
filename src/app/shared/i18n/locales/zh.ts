...
export const zh: TranslationKeys = {
  ...
  // =========================================================================
  // 应用首页落地页(根路由重定向判断时短暂显示——在设置清单与任务看板之间)
  // =========================================================================
  appLanding: {
    opening: '正在打开工作区...',
  },
  ...
  // =========================================================================
  // 任务人工更新(Updates 页的记录与阻塞标记)
  // =========================================================================
  taskComments: {
    title: '人工更新',
    empty: '还没有记录。可以提问、留下决定，或标记阻塞。',
    loadingTitle: '正在加载讨论',
    loadingDetail: 'Forge 正在加载这个任务的记录与阻塞标记。',
    loadingNext: '如果耗时过长，请从任务页面重新打开此任务。',
    loadingSuccess: '加载后应能看到记录与阻塞标记。',
    inputLabel: '写一条记录或标记阻塞',
    placeholder: '写一条记录或标记阻塞...',
    kindLabel: '更新类型',
    post: '发布',
    posting: '发布中...',
    delete: '删除',
  ...
  // =========================================================================
  skillAgents: {
    sectionHeading: '关联的智能体',
    empty: '还没有智能体关联此技能。',
    attach: '关联',
    attaching: '关联中...',
    attachError: '无法将此技能关联到该智能体,请重试。',
    detachAria: '解除与 {name} 的关联',
    detachError: '无法解除关联,请重试。',
    selectLabel: '选择要关联的智能体',
    selectPlaceholder: '选择智能体...',
    unnamedAgent: '某个智能体',
    usageNever: '尚未在任何任务中使用过。',
    usageRuns: '已在 {{runs}} 次任务运行中使用。',
    usageLastUsed: '上次使用于 {{when}}。',
  },
  ...
  about: {
    update: {
      label: '更新检查',
      description: '检查 Forge 是否已发布更新的版本。',
      check: '检查更新',
      checking: '检查中...',
      upToDate: '已是最新版本 ({{version}})',
      available: '有新版本可用 ({{version}})',
      unreachable: '无法检查 —— 请重试',
    },
  },

  // =========================================================================
  // 运维总览 —— 运行环境、服务、智能体与队列一处查看
  // =========================================================================
  operations: {
    title: '运维总览',
    subtitle: '在任务被阻塞前,一处查看运行就绪、AI 服务、智能体与队列状态。',
    refresh: '刷新',
    allClear: '一切正常,工作正在流动。',
    attention: '有 {{count}} 项需要处理。',
    loadingTitle: '正在检查工作区',
    loadingDetail: 'Forge 正在检查运行就绪、服务、智能体与队列。',
    loadingNext: '如果耗时过长,请重新打开此页面。',
    loadingSuccess: '加载后应能看到各项状态,以及每个需要处理的直接动作。',
    sso: {
      title: '企业登录',
      off: '已关闭 — 用户使用邮箱和密码登录。',
      configured: '已开启 — 登录页提供 {{provider}}。',
    },
    cards: {
      runtime: {
        title: '工作位置',
        ready: '已就绪,可运行容器/CLI 工作。',
        notReady: '派发任务前,先设置智能体的工作位置。',
      },
      providers: {
        title: 'AI 服务',
        ready: '已有一个通过验证并启用的服务。',
        needsTest: '保存服务后,请选择“检查连接”。',
        none: '添加并验证一个 AI 服务,或连接工作工具登录。',
      },
      agents: {
        title: '智能体',
        ready: '有 {{count}} 个智能体可用于任务。',
        none: '当前没有可用于任务的智能体。',
      },
      queue: {
        title: '任务队列',
        ready: '工作正在流动。',
        stalled: '有任务在等待,但暂无进展。',
      },
      health: {
        title: '应用健康',
        ok: '数据库、消息与运行时正常。',
        degraded: '部分检查未通过:{{details}}。请打开管理页面查看下一步。',
      },
    },
  },
  ...
  gettingStarted: {
    ...
    steps: {
      ...
      provider: {
        title: '给智能体一个工作方式',
        empty:
          '先选一种方式：添加模型服务用于文字回答，或先打开改文件工具登录，再创建需要项目文件的任务。',
      ...
      agent: {
        title: '智能体',
        empty: '创建一个任务智能体：项目文件智能体，或这台电脑上的智能体。文字智能体只能用于聊天。',
        why: '任务智能体会接收任务并返回结果；文字智能体只在聊天中回答。',
        success: '智能体页面里至少能看到一个项目文件智能体或这台电脑上的智能体。',
        create: '创建智能体',
        review: '打开智能体',
      },
      routing: {
  ...
  settings: {
    ...
    runtime: {
      ...
      defaultRuntimeDescription:
        '需要共享修改项目文件时，选择“项目文件”最简单。只有工作需要用这台电脑上的文件和工具时，才选择这台电脑。',
      defaultContainerCliLabel: '项目工作默认工具',
      defaultContainerCliDescription:
        '智能体修改项目文件或运行检查时使用的 Claude Code、Codex、Gemini 或 OpenCode',
      availableRuntimesLabel: '可选的文件位置',
      availableRuntimesDescription: '这些选项会出现在“项目文件打开位置”里',
  ...
  skills: {
    detail: {
      closeAria: '关闭',
      close: '完成',
      subtitle: '团队可复用的 Skill。',
      statusReady: '可以使用',
      statusNeedsInstall: '使用前检查',
      cliFit: '最适合文件编辑工具：{{tool}}',
      unknownToolFit: '在设置里检查文件编辑工具',
      allAgentsFit: '不需要指定工具',
      allAgentsTooltip: '这条 Skill 不需要指定文件编辑工具。',
      containerCliTooltip: '文件编辑工具：{{tool}}',
      unknownToolTooltip: '打开设置，检查文件编辑工具，然后再使用这条 Skill。',
      nextStepHeading: '下一步做什么',
      nextStepReady: '创建任务时可以使用这条 Skill，也可以让匹配词在类似任务中提示它。',
      nextStepNeedsInstall: '请让所有者或管理员先完成设置，然后再在任务中使用这条 Skill。',
      sourceLabel: '保存位置',
      authorLabel: '更新人',
      availabilityLabel: '谁可以使用',
      descriptionHeading: '它能帮什么',
      noDescription: '使用这条 Skill 前，请先查看下面的可复用指引。',
      triggerHeading: '什么时候有帮助',
      triggerHelper: '任务里出现类似这些词时，可以推荐这条 Skill。',
      detailsHeading: '可复用指引',
      detailsHelper: '使用这条 Skill 前，请先查看这些可复用步骤。',
      noContent: '还没有保存可复用步骤。请先补充智能体要遵循的步骤，再使用这条 Skill。',
      unknownAuthor: '请重新打开 Skills，查看谁负责更新它',
      unknownSource: 'Skills',
      availabilityWorkspace: '当前团队空间',
      availabilityGlobal: '所有人',
      availabilityProject: '当前项目',
      availabilityLatest: '最新保存版本',
      availabilityNeedsReview: '检查谁可以使用',
    },
  },
  ...
  reviewChecklist: {
    ...
    allDone: '复查完成，感谢你的确认。',
    resultMatchesBrief: '结果完成了任务要求的内容。',
    artifactsChecked: '我查看了结果文件，内容无误。',
    noSecrets: '结果中没有密钥或私人信息。',
    reusableSaved: '可复用的内容已保存，供下次使用。',
    loadError: '无法加载这个复查清单，请检查网络后重新打开任务。',
    saveError: '无法保存这笔勾选，请再试一次。',
    gatesWarning: '还有 {{missing}} 项必检未完成——在勾选完成前，任务不能标记为完成。',
    gatesSatisfied: '所有必选项都已完成，该任务可以标记为完成。',
  },
  ...
  // =========================================================================
  waitEstimate: {
    startsIn: '约 {{min}} 分钟后开始',
    basis: '队列前方第 {{position}} 位；近期任务平均约 {{typicalMin}} 分钟。',
    noHistory: '队列前方第 {{position}} 位；暂无近期任务用时数据，此时间仅作参考。',
    changeHint: '你可以在任务上调整执行者或优先级来影响开始时间。',
  },
} as const
