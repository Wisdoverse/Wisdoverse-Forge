...
export const zh: TranslationKeys = {
  ...
  gettingStarted: {
    ...
    steps: {
      ...
      routing: {
        ...
        why: '这里是新任务等待的地方，可用的智能体会从这里领取任务。',
      ...
      task: {
        title: '第一个任务',
        emptyWithRouting: '写一个小任务。Forge 会把它放到任务等待位置，等可用的智能体领取。',
        ...
        success: '看板上能看到任务，状态是等待领取或已分配给智能体。',
        create: '写第一个任务',
        open: '打开看板',
      },
      review: {
        title: '检查结果',
        empty: '智能体领取任务后，打开任务就能查看进度和结果。',
  ...
  skills: {
    detail: {
      ...
      statusReady: '可以使用',
      statusNeedsInstall: '需要先安装，智能体才能使用',
      cliFit: '最适合 {{tool}}',
      ...
      nextStepNeedsInstall: '先请所有者或管理员安装它，再期望智能体在任务中使用它。',
      sourceLabel: '来源',
      authorLabel: '更新人',
