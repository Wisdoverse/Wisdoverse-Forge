  ...
  gettingStarted: {
    ...
    steps: {
      ...
      runtime: {
        ...
        why: '平台需要先知道会话在哪里运行，才能启动或分配工作。',
        success: '运行时页面至少显示一个运行时和一个 Container CLI 选项。',
        open: '检查运行时',
        review: '查看运行时',
      },
      provider: {
        ...
        why: '会话需要可用的模型服务，或一个已接入的 CLI，才能真正执行任务。',
        success: '模型服务测试通过，或 Host CLI / Container CLI 会话已经接入。',
        create: '添加服务',
