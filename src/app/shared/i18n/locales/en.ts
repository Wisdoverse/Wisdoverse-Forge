...
export const en = {
  ...
  gettingStarted: {
    ...
    steps: {
      ...
      provider: {
        title: 'How agents can answer',
        empty: 'Connect a model service or local agent so agents can start work.',
        needsTest: 'Check the model service before assigning work.',
        cliReady: '{{name}} can run work from {{location}}.',
        why: 'Agents need a checked model service or connected local agent before they can answer or run work.',
        success: 'A model service is checked, or a local agent is connected.',
      ...
      routing: {
        title: 'Work lane',
        emptyWithProject: 'Create a work lane for this project.',
        emptyWithoutProject: 'Select a project, then create a work lane.',
        why: 'A work lane is where new tasks wait and where agents pick them up.',
        success: 'A work lane exists for the selected project.',
        create: 'Create work lane',
        review: 'Review work lanes',
      },
      task: {
        title: 'First task',
