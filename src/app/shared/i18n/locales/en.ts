...
export const en = {
  ...
  skills: {
    detail: {
      closeAria: 'Close',
      close: 'Done',
      subtitle: 'A skill the team can reuse.',
      ...
      allAgentsTooltip: 'This skill does not require a specific file editing tool.',
      containerCliTooltip: 'File editing tool: {{tool}}',
      unknownToolTooltip: 'Open Settings, check the file-editing app, then use this skill.',
      nextStepHeading: 'What to do next',
      nextStepReady:
        'Use this skill when creating a task, or let matching words suggest it for similar work.',
      nextStepNeedsInstall: 'Ask an owner or admin to finish setup, then use this skill in a task.',
      sourceLabel: 'Saved in',
      authorLabel: 'Updated by',
      availabilityLabel: 'Who can use it',
      descriptionHeading: 'What this helps with',
      noDescription: 'Check the reusable guidance below before using this skill.',
      triggerHeading: 'When this helps',
      triggerHelper: 'Use this skill for tasks that include words like these.',
      detailsHeading: 'Reusable guidance',
      detailsHelper: 'Read these reusable steps before using this skill.',
      noContent:
        'No reusable steps are saved yet. Add the steps agents should follow before using this skill.',
      unknownAuthor: 'Open Skills again to show who keeps this updated',
