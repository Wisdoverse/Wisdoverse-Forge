    ...
    if (!loaded) {
      return (
        <FeatureRouteLoadingState
          ...
          detail="We are confirming whether governance audit is enabled for this workspace. If this takes more than a moment, refresh the page or ask an administrator to check setup."
        />
      )
    }
