...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| First-run setup and `/start`                                 | `src/app/routes/start.tsx`, `src/app/routes/landing.ts`, `src/app/pages/getting-started/ui/GettingStartedView.tsx`, `src/app/layouts/sidebar/SidebarNav.tsx`, `src/app/shared/model/settings.store.ts` | `GettingStartedView.test.tsx`, `SidebarNav.test.tsx`, `routing.test.tsx`, `settings.store-preferences.test.ts`, `i18nBeginnerErrors.test.ts`                                                                                                                                                                                | ACTION | Phase 2 owns the skip/hide/reset behavior: completed setup should land on Tasks, the setup checklist should hide from navigation, and Settings must offer a reset path. |
