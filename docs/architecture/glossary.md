...
| **Task queue**            | The beginner-facing place where new tasks wait until an agent is ready to pick them up. Backed by an agent group/work lane in code and API contracts. Use **Task queue** in first-run and task-creation UI so non-specialist users know what will happen next.                                                                                      |
