...
| Identity          | `organizations`, `teams`, `groups`                                                 | `repositories/identity/`          | `services/organization`, `services/team`, `services/group`, `services/auth`                                                                         | `domain/auth`, shared group rules in `domain/resource`                                                                        | `routes/auth`, `routes/organizations`, `routes/teams`, `routes/groups`                                           |
