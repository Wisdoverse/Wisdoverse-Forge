...
describe('beginner error translations', () => {
  ...
  test('limit and conflict messages tell beginners what to change next', () => {
    ...
    expect(en.files.uploadFailed).toContain('Check the file')
    ...
    expect(zh.files.uploadFailed).toContain('检查文件')
  ...
  test('destructive confirmations explain the impact before users confirm', () => {
    ...
    expect(en.confirm.delete).toContain('removed from this workspace')
    ...
    expect(en.admin.users.confirmDelete).toContain('lose access')
    ...
    expect(zh.confirm.delete).toContain('从当前工作区移除')
    ...
    expect(zh.admin.users.confirmDelete).toContain('失去当前工作区访问权限')
