...
describe('beginner error translations', () => {
  ...
  test('empty states include a next step', () => {
    ...
    expect(en.skills.detail.subtitle).toBe('Saved guidance the team can reuse.')
    ...
    expect(en.skills.detail.triggerHelper).toContain('Use this saved guidance')
    expect(en.skills.detail.detailsHelper).toContain('before using this saved guidance')
    ...
    expect(en.skills.detail.unknownSource).toBe('Saved guidance')
