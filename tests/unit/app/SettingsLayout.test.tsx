...
describe('SettingsLayout', () => {
  test('uses task-first setup labels in desktop and mobile navigation', () => {
    ...
    expect(
      within(desktopNav).getByRole('button', {
        name: /Work tool sign-in: Sign in to Codex and other work tools agents use for file work/i,
      })
    ).toBeInTheDocument()
    expect(
      within(desktopNav).getByRole('button', {
    ...
    expect(screen.getByRole('option', { name: 'Work tool sign-in' })).toBeInTheDocument()
