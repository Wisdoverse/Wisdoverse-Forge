...
describe('navigation.store', () => {
  ...
  it('turns raw service details without status into owner check guidance', () => {
    const message = navigationActionErrorMessage('teamProjects', 'load', {
      serverError: 'database unavailable while loading teams',
    })
    ...
    expect(message).not.toContain('Choose a team space')
  })
