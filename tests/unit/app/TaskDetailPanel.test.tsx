...
describe('TaskDetailPanel', () => {
  ...
  test('shows completed result readiness in task updates', async () => {
    ...
    expect(screen.getByText(/1 result file ready to check/i)).toBeDefined()
  ...
  test('guides beginner review on the result tab', async () => {
    ...
    expect(screen.getByText(/check the result before closing/i)).toBeDefined()
    expect(screen.getByText(/compare with the brief/i)).toBeDefined()
    expect(screen.getByText(/check result files/i)).toBeDefined()
    expect(screen.getByText(/1 result file attached for checking/i)).toBeDefined()
  ...
  test('shows available agents as selectable handoff cards', async () => {
    ...
    expect(screen.getByText('Can build the task and check the result')).toBeDefined()
