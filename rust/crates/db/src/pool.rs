...
const MIGRATION_SOURCES: &[(&str, &str)] = &[
    ...
    (
        "018_legacy_nav_validate_projects_team_fk.sql",
        include_str!("../migrations/018_legacy_nav_validate_projects_team_fk.sql"),
    ),
    (
        "019_legacy_nav_validate_groups_project_fk.sql",
        include_str!("../migrations/019_legacy_nav_validate_groups_project_fk.sql"),
    ),
    ...
    (
        "023_legacy_nav_idx_projects_team_slug.sql",
        include_str!("../migrations/023_legacy_nav_idx_projects_team_slug.sql"),
    ),
    ...
    (
        "035_orchestration_blocked_reason_triggers.sql",
        include_str!("../migrations/035_orchestration_blocked_reason_triggers.sql"),
    ),
    (
        "036_user_credential_schema_ownership.sql",
        include_str!("../migrations/036_user_credential_schema_ownership.sql"),
    ),
    ...
    (
        "041_team_project_member_role_constraints.sql",
        include_str!("../migrations/041_team_project_member_role_constraints.sql"),
    ),
    ...
    (
        "056_run_context_injections_applied_at_idx.sql",
        include_str!("../migrations/056_run_context_injections_applied_at_idx.sql"),
    ),
