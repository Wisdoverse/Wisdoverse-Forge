...
pub fn apply_codex_adapter(envelope: &ContextEnvelope, home: &Path) -> Result<ContextAdapterReport> {
...
fn render_context_block(envelope: &ContextEnvelope) -> String {
    ...
    out.push_str("These instructions are generated for Codex from the approved AgentForge context envelope.\n\n");
